...
<template>
    <section class="stay-preview">
        <el-carousel trigger="click" height="200px" :autoplay="false" :loop="false">
      ...
      <section class="preview-text">
        <div class="preview-rate">
          <p v-if="stay.reviews.length"><span class="star">⭐</span>{{avgRate}}<span> ({{stay.reviews.length}})</span></p>
